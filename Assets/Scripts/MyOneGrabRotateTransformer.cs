...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class MyOneGrabRotateTransformer : MonoBehaviour, ITransformer
    {
        public enum Axis
        {
            Right = 0,
        ...
        public UnityEvent StartRotating = new UnityEvent();
        public UnityEvent EndRotating = new UnityEvent();


        [Serializable]
        public class MyOneGrabRotateConstraints
        {
        ...
        [SerializeField]
        private MyOneGrabRotateConstraints _constraints =
            new MyOneGrabRotateConstraints()
            {
                MinAngle = new FloatConstraint(),
                MaxAngle = new FloatConstraint()
            };

        public MyOneGrabRotateConstraints Constraints
        {
            get
            {
                return _constraints;
        ...
        public void Initialize(IGrabbable grabbable)
        {
            ...
            targetTransform = _grabbable.Transform;
        }
        ...
        public void InjectOptionalConstraints(MyOneGrabRotateConstraints constraints)
        {
